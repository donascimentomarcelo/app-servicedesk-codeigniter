                                ...
                                <div class="content-grid mdl-grid">
                                    <div class="mdl-cell mdl-cell--6-col">
                                        ...
                                        <div>
                                            ...
                                            <button type="button" ng-click="actionConfig(action)" ng-if="!inventarioConfig.$invalid" class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect"><i class="material-icons">archive</i></button>
                                            <!-- </div>  -->
                                        </div>  
                                    </form>
                                </div>
